    ...
    <body class="relative">
                ...
                <div class="hidden md:flex space-x-8 font-medium">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition
                            ...
                            <a href="{{ url('/kurikulum') }}"
                                class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">Taruna Nusantara Center</a>
                        </div>
                    </div>
                    <a href="#" class="hover:text-blue-600">EVENT & NEWS</a>
                </div>
            </div>
        </nav>
        ...
        <p class="text-7xl">Tahap Pengembangan</p>
