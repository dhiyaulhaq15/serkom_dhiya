...
<div class="h-20 w-full">
    <header class="flex items-center justify-between bg-white p-5 shadow-md rounded-2xl mt-4">
    ...
    <div class="max-w-2xl mx-auto py-10 px-6">
        <div class="bg-white shadow-lg rounded-2xl p-8 border border-gray-100">
            <h2 class="text-3xl font-bold text-gray-800 mb-6 text-center">
                <i class="fa-solid fa-users text-blue-600 mr-2"></i>Tambah Ekstrakurikuler
            </h2>
            ...
            <form action="{{ route('admin.ekstrakurikuler.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf

                {{-- Nama --}}
                <div>
                    <label for="nama" class="block text-sm font-semibold text-gray-700 mb-1">Nama Ekstrakurikuler</label>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="gambar"
                            ...
                            <div class="flex flex-col items-center justify-center pt-5 pb-6 text-gray-600">
                                ...
                                <p class="mb-2 text-sm"><span class="font-semibold">Klik untuk memilih file</span> atau seret ke sini</p>
                ...
                <div class="flex justify-between items-center pt-4">
                    ...
                    <button type="submit"
                        class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2.5 rounded-lg shadow transition">
