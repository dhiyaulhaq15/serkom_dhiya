                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($siswa as $sis)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700">{{ $sis->alamat }}</td>
                            <td class="px-6 py-4 text-sm text-gray-700">{{ $sis->tanggal_lahir }}</td>
                            {{-- <td class="px-6 py-4 text-sm text-gray-700">{{ $g->role->no_hp }}</td> --}}
